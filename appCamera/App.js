...
import {
  View, Text, StatusBar, StyleSheet, TouchableOpacity, Modal,
  Image,
      ...
      >
        {({ camera, status, recordAndroidPermissionStatus }) => {
          ...
          return (
            <View
              style={{
                marginBottom: 35, flexDirection: 'row', alignItems:
                  'flex-end', justifyContent: 'space-between'
              }}
            >
              <TouchableOpacity
      ...
      {capturedPhoto &&
        <Modal animationType="slide" transparent={false}
          ...
          <View style={{
            ...
            >
              <Text style={{ fontSize: 24, color: '#555' }}>Fechar</Text>
            </TouchableOpacity>
            <Image
              resizeMode="contain"

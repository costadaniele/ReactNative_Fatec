...
export default class App extends Component {
  ...
  preChamadaApi() {
    ...
    const alertaUsuario = (moeda) => {
      alert(`Conversão ${moeda} para Bitcoin indisponível.`)
    }

    const moeda1 = this.state.moeda1
    const moeda2 = this.state.moeda2
    ...
    return(
      <View style={style.container}>
        ...
        <View style={style.inputBox}>
            <Text style={style.tituloInput}>Valor:</Text>
            <TextInput
        ...
        <View style={style.inputBox}>
            <Text style={style.tituloInput}>De: </Text>
            <Picker
        ...
        <View style={style.inputBox}>
            <Text style={style.tituloInput}>Para: </Text>
            <Picker
        ...
        <Text style={style.titulo}>Valor convertido</Text>

       <Text style={style.titulodetalhe}> Clique abaixo </Text>
        <View style={style.resposta}> 
          <Text style={style.txtResposta}> 
